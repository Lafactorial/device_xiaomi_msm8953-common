...
LOCAL_OVERRIDES_PACKAGES := AudioFX PixelWallpapers2021
LOCAL_OVERRIDES_PACKAGES := AmbientSensePrebuilt AppDirectedSMSService
LOCAL_OVERRIDES_PACKAGES += CalendarGooglePrebuilt CalculatorGooglePrebuilt Camera2 Chrome  Chrome-Stub CarrierSetup ConnMO DCMO
LOCAL_OVERRIDES_PACKAGES += DMService DevicePolicyPrebuilt Drive PrebuiltGmail
LOCAL_OVERRIDES_PACKAGES += DiagnosticsToolPrebuilt FilesPrebuilt KidsSupervisionStub Maps Velvet
...
LOCAL_OVERRIDES_PACKAGES += PixelLiveWallpaperPrebuilt PhotoTable Stk talkback
