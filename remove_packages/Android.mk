...
LOCAL_OVERRIDES_PACKAGES := AmbientSensePrebuilt AppDirectedSMSService CalculatorGooglePrebuilt
LOCAL_OVERRIDES_PACKAGES += CalendarGooglePrebuilt Camera2 CarrierSetup ConnMO DCMO
LOCAL_OVERRIDES_PACKAGES += DMService DevicePolicyPrebuilt Drive PrebuiltGmail
LOCAL_OVERRIDES_PACKAGES += DiagnosticsToolPrebuilt FilesPrebuilt GoogleCamera Maps Velvet
